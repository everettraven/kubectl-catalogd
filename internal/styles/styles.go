...
var CatalogNameColor = lipgloss.AdaptiveColor{Light: "#000000", Dark: "#ffffff"}
var CatalogNameBackground = lipgloss.AdaptiveColor{Light: "#E791A9", Dark: "#B06482"}
var CatalogNameStyle = lipgloss.NewStyle().Foreground(CatalogNameColor).Background(CatalogNameBackground).Bold(true).Padding(0, 1)
